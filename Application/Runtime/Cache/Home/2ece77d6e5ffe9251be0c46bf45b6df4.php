						...
						<div class="row">
							<div class="col-5">
								<form class=" " id="myform" action="" method="post">
									...
									<div class="form-group">
										...
										<div>
											...
											<td><input type="file" id="fielinput" name="" />
												<img class="pic_url" id="txshow"
													src="http://iframe.qadmin.net/static/admin/img/pic.png"
													height="200px">
									...
									<div class="form-group">
										<label>标题</label>
										<input type="text" name="produceName" class="form-control">
										<small class="form-text text-muted"></small>
									</div>
									...
									<div class="form-group">
										...
										<select name="sKind" class="form-control">
											<?php if(is_array($show_type)): foreach($show_type as $k=>$v): ?><option value="<?php echo ($v["partitionidname"]); ?>"><?php echo ($v[partitionidname]); ?></option><?php endforeach; endif; ?>
										</select>
										<small class="form-text text-muted"></small>
									...
									<div class="form-group">
										<label>标签</label>
										<input type="text" name="produceLabel" class="form-control"
											placeholder="用英文豆号隔开">
										<small class="form-text text-muted"></small>
									</div>
									...
									<div class="form-group hid">
										<label>附件地址</label>
										<input type="text" id="hid-link" name="produceLink" class="form-control"
											placeholder="不上传就留空 可使用外链http://">

									</div>
									<div class="form-group hid">
										<label>资源状态</label>
										<input type="text" id="hid-state" name="Productstatus" class="form-control"
											placeholder="">
										<input type="hidden" name="produceDate" id="" value="" />
										<input type="hidden" name="produceDate" id="" value="" />
									</div>
