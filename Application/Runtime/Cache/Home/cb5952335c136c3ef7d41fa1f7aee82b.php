...
<html lang="en">
	...
	<head>
		...
		<title>添加栏目 - BsAdmin后台模板 - 经典版演示</title>
								...
								<div class="row">
									<div class="col-5">
										<form class="" action="" method="post">
											<input type="hidden" name='partitionId' value="<?php echo ($info["partitionid"]); ?>" />
											<div class="form-group">
												<label>分类名称</label>
												<input type="text" name="partitionIdName" value="<?php echo ($info["partitionidname"]); ?>" class="form-control">
