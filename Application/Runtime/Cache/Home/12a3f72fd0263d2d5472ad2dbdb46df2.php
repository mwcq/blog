	...
	<body>
		...
		<div id="app" class="d-flex">
			...
			<nav>
				...
				<ul class="menu">
					<li>
						<a href="main.html"><i class="iconfont mr-1">&#xe6a2;</i>首页</a>
					</li>
					<li>
						<a class="top-menu" href="javascript:;"><i class="iconfont mr-1">&#xe6e0;</i>用户管理<i class="iconfont arrow float-right">&#xe66c;</i></a>
						<ul class="sub-menu">
							<li>
								<a href="user_index.html">用户列表</a>
							</li>
							<li>
								<a href="user_create.html">添加用户</a>
							</li>
						</ul>
					</li>
					<li>
						<a class="top-menu" href="javascript:;"><i class="iconfont mr-1">&#xe69d;</i>文章管理<i class="iconfont arrow float-right">&#xe66c;</i></a>
						<ul class="sub-menu">
							<li>
								<a href="type_index.html">栏目管理</a>
							</li>
							<li>
								<a href="article_index.html">文章管理</a>
							</li>
						</ul>
					</li>
					<li>
						<a class="top-menu" href="javascript:;"><i class="iconfont mr-1">&#xe6d4;</i>系统设置<i class="iconfont arrow float-right">&#xe66c;</i></a>
						<ul class="sub-menu">
							<li>
					...
					<li>
						<a class="top-menu" href="javascript:;"><i class="iconfont mr-1">&#xe6ad;</i>数据库<i class="iconfont arrow float-right">&#xe66c;</i></a>
						<ul class="sub-menu">
							<li>
										...
										<form method="post">
											...
											<div class="form-group">
												...
												<td><input type="file" id="fielinput" name="" />
													<img id="txshow" src="<?php echo ($info["userphoto"]); ?>" style="width:80px;height:80px;" />
													<input type="hidden" name="userPhoto" id="data" value="<?php echo ($info["userphoto"]); ?>" />
													
													<!--<input type="submit" onclick="submitForm('/jscss/admin/design/upload')" value="上传图片"/>--></td>
											</div>
											<div class="form-group">
												<label>手机号:</label>
												<input type="number" value="<?php echo ($info["userphone"]); ?>" name="userPhone" class="form-control">
												<small class="form-text text-muted"></small>
											</div>

											<div class="form-group">
												<label>登录名:</label>
												<input type="text" value="<?php echo ($info["loginname"]); ?>" name="loginName" class="form-control">
												<small class="form-text text-muted"></small>
											</div>

											<div class="form-group">
												<label>密码:</label>
												<input type="text" value="<?php echo ($info["userpassword"]); ?>" name="userPassword" class="form-control">
												<small class="form-text text-muted"></small>
											</div>
											<div class="form-group">
												<label>昵称:</label>
											...
											<div class="form-group">
												<label>邮箱:</label>
												<input type="email" value="<?php echo ($info["useremail"]); ?>" name="userEmail" class="form-control">
												<small class="form-text text-muted"></small>
											</div>
											<div class="form-group">
												出生日期：
												<input class="common-text" value="<?php echo ($info["userbirth"]); ?>" name="userBirth" size="50" value="" type="date">
											</div>
											<div class="form-group">
												<label>性别:</label> 男
											...
											<div class="form-group">
												<label>故乡:</label>
												<input type="text" value="<?php echo ($info["useraddress"]); ?>" name="userAddress" class="form-control">
												<small class="form-text text-muted"></small>
											</div>
											<div class="form-group">
												<label>权限:</label>
												<?php switch($info["userpower"]): case "1": ?><select name="userPower">
													<option value="">请选择用户权限</option>
													<option value="3">超级管理员</option>
													<option value="2">管理员</option>
													<option value="1" selected="selected">普通用户</option>
												</select><?php break;?>
												<?php case "2": ?><select name="info.userPower">
													<option value="">请选择用户权限</option>
													<option value="3">超级管理员</option>
													<option value="2" selected="selected">管理员</option>
													<option value="1">普通用户</option>
												</select><?php break;?>
												<?php case "3": ?><select name="info.userPower">
													<option value="">请选择用户权限</option>
