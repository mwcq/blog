					...
					<main>
						<div class="main">
							<div class="search">
								...
								<a class="btn btn-primary float-right" href="<?php echo U(user_create);?>"><i
								...
								<table class="table">
									...
									<tbody>
										...
										<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
												<th scope="row"><img src="<?php echo ($v["userphoto"]); ?>" alt="" width="50px"
														height="50px" /></th>
												...
												<td>
													<?php switch($v["userpower"]): case "3": ?>超级管理员<?php break;?>
														<?php case "2": ?>管理员<?php break;?>
														<?php case "1": ?>普通用户<?php break;?>
														<?php default: ?>default<?php endswitch;?>
												</td>
												<td>
													<a href="<?php echo U('user_edit',array('userid' => $v['userid']));?>">修改</a>
													<a class="del"
														href="<?php echo U('user_del',array('userid' => $v['userid']));?>">删除</a>
												</td>
							...
							<div class="page">
								<span class="total float-left page-link">共<?php echo ($cont); ?>条</span>
								<ul class="pagination">
